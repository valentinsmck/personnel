...
public class Employe implements Serializable, Comparable<Employe>
{
    ...
    public void setDateArrivee(LocalDate dateArrivee) throws DateIncoherenteException {
        if (this.dateDepart != null && dateArrivee.isAfter(this.dateDepart)) {
            throw new DateIncoherenteException("La date d'arrivée ne peut pas être postérieure à la date de départ.");
        }
    ...
    public void setDateDepart(LocalDate dateDepart) throws DateIncoherenteException {
        if (dateDepart != null && dateDepart.isBefore(this.dateArrivee)) {
            throw new DateIncoherenteException("La date de départ ne peut pas être antérieure à la date d'arrivée.");
        }
...
// ... (tout le début du fichier Employe.java reste identique) ...
    ...
    /**
     * MODIFIÉ POUR INCLURE LES DATES
     */
    @Override
    public String toString()
    {
        ...
        res += ", Arrivé le: " + dateArrivee;
        if (dateDepart != null)
            res += ", Parti le: " + dateDepart;
